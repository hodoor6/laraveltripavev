...
class Lesson30WorldSiteCountry extends Model
{
...
protected $table = 'lesson30worldsitecountries';
...
//    ];
    ...
    {
        return $this->hasMany('App\Model\Lesson30WorldSiteCity','country_id');
    }

    public function showplace()
    {
        return $this->hasManyThrough('App\Model\Lesson30WorldSiteShowplace', 'App\Model\Lesson30WorldSiteCity','country_id', 'city_id');
    }
