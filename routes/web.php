...
Route::get('/lesson16-1/flash', 'Lesson16@lesson16_1flash')->name('flash1');
...
Route::get('/lesson16-2/flash', 'Lesson16@lesson16_2flash')->name('flash2');
...
Route::get ('/lesson21-24/', 'Lesson21@lesson21_24');

// Урок 21. (laravel).  Задача 25 Из таблицы employees для каждой должности получите минимальную зарплату.
Route::get ('/lesson21-25/', 'Lesson21@lesson21_25');

// Урок 21. (laravel).  Задача 26 Из таблицы employees для каждой должности получите минимальную зарплату.
Route::get ('/lesson21-26/', 'Lesson21@lesson21_26');

 // Урок 21. (laravel).  Задача 27 Из таблицы employees получите работников, у которых день рождения приходится на 25 день месяца.
Route::get ('/lesson21-27/', 'Lesson21@lesson21_27');
...
Route::get ('/lesson22-3/', 'Lesson22@lesson22_3');

// Урок 22. (laravel).  Задача 4 С помощью построителя запросов добавьте сразу 3 новых юзера в таблицу users.
...
Route::get ('/lesson25-3/post/all/', 'Lesson25@lesson25_3getAll');


//Урок 25. (laravel). Задача4.  В контроллере PostController сделайте действие getOne для получения одной статьи по ее id. Пусть это действие будет доступно по адресу /post/:id/, где :id представляет собой id желаемой записи. //Не забудьте наложить ограничение регулярным выражением на наш параметр.
Route::get ('/lesson25-4/post/{id}/', 'Lesson25@lesson25_4getOne')->where('id','[1-9]+');
...
Route::get ('/lesson25-5/post/{id}/', 'Lesson25@lesson25_5getOne')->where('id','[1-9]+');
...
Route::get ('/lesson25-6/post/all/', 'Lesson25@lesson25_6getAll');
...
Route::get ('/lesson25-7/post/all/', 'Lesson25@lesson26_7getAll');
...
Route::get('/lesson26-2/', 'Lesson26@lesson26_2');
// Урок 26. (laravel). Задача 3  Сделайте самостоятельно описанное мною редактирование статьи.

Route::match(['get', 'post'],'/lesson26-3/{id}', 'Lesson26@lesson26_3edit');
...
Route::match(['get', 'post'],'/lesson26-6/{id}', 'Lesson26@lesson26_6edit');
...
Route::get('/lesson26-9/{id}', 'Lesson26@lesson26_9');

//Урок 26 Задача 10://Задача 10: "Создайте модель с помощью массового заполнения firstOrNew()."
//
...
Route::get('/lesson26-10/{id}', 'Lesson26@lesson26_10');//Урок 26 Задача 10://Задача 10: "Создайте модель с помощью массового заполнения firstOrNew()."
//
...
Route::get('/lesson26-11/{id}', 'Lesson26@lesson26_11');
...
Route::get('/lesson27-1/post/del/{id}', 'Lesson27@lesson27_1delPost');

// Урок 27. (laravel). Задача 2.  Отредактируйте представление действия getAll так, чтобы появилась еще одна колонка со ссылкой на удаления соответствующей статьи. //После удаления выполняйте редирект обратно на список статей с флеш сообщением об успешном удалении статьи. Сообщение должно содержать title удаленной статьи.

Route::get('/lesson27-2/post/del/{id}', 'Lesson27@lesson27_2delPost');
...
// Урок 28. (laravel). Задача 3.Получите всех пользователей вместе с их профилями, передайте полученный массив в представление и выведите на экран в виде HTML таблицы table.
Route::get('/lesson28-3/', 'Lesson28@lesson28_3');


// Урок 28. (laravel). Задача 5. Получите какого-нибудь пользователя вместе с его городом. .
Route::get('/lesson28-5/', 'Lesson28@lesson28_5');
...
// Урок 28. (laravel). Задача 9. Получите все города вместе с их странами.
Route::get('/lesson28-9/', 'Lesson28@lesson28_9');
...
// Урок 28. (laravel). Задача 12. Получите все страны вместе с их городами.
Route::get('/lesson28-12/', 'Lesson28@lesson28_12');


// Урок 28. (laravel). Задача 12. Получите все страны вместе с их городами.
Route::get('/lesson28-12-1/', 'Lesson28@lesson28_12_1');
...
Route::get('/lesson28-13/', 'Lesson28@lesson28_13');


// Урок 28. (laravel). Задача 14. Получите продукты вместе с их категориями.
Route::get('/lesson28-14/', 'Lesson28@lesson28_14');

// Урок 28. (laravel). Задача 15. Получите категории вместе с продуктами, принадлежащими этим категориям.
Route::get('/lesson28-15/', 'Lesson28@lesson28_15');


// Урок 28. (laravel). Задача 16. Ленивая и нетерпеливая (жадная) загрузка Получите категории вместе с продуктами, принадлежащими этим категориям.
Route::get('/lesson28-16/', 'Lesson28@lesson28_16');
...
Route::get('/lesson29-3/', 'Lesson29@lesson29_3');

//Урок 29. (laravel). Задача 4. Отсоединить продукт с id = 6 к категории с id = 2. (многие ко многим).
Route::get('/lesson29-4/', 'Lesson29@lesson29_4');


//Урок 29. (laravel). Задача 5. Продолжение задачи 3. Есть в промежуточной таблице есть еще одна колонка 'attribute'. Надо изменить в ней значение на '10' для продукта (id = 3) и категории (id = 7).

Route::get('/lesson29-5/', 'Lesson29@lesson29_5');


//Урок 29. (laravel). Задача 6. Продолжение задачи 3. Для продукта (id = 8) осуществить связь с категориями (id =5, 9). Остальные категории удалить.

Route::get('/lesson29-6/', 'Lesson29@lesson29_6');
...
Route::get('/lesson29-10/', 'Lesson29@lesson29_10');
...
Route::match(['get', 'post'], '/lessonQueryBuilder30-1/', 'Lesson30GuestBookQueryBuilder@lesson30_1');
...
Route::match(['get', 'post'], '/lessonQueryBuilder30-2/moderator', 'Lesson30GuestBookQueryBuilder@lesson30_2moderator');
...
Route::match(['get', 'post'], '/lesson30-3/', 'Lesson30Ads@lesson30_3');
Route::match(['get', 'post'], '/lesson30-3/ads/{id}', 'Lesson30Ads@lesson30_3Ads')->where('id','[1-9]+');
...
//Урок 32. (laravel). Задача 2.  Найти минимальную, максимальную, среднюю зарплату, а также ее сумму.
