...
<form action="" method="POST">
    {{ csrf_field() }}
    <input type="text" name="title" placeholder="Заголовок" value="{{ old('title') }}"><br><br>
    <textarea name="desc" placeholder="Краткий текст">{{ old('desc') }}</textarea><br><br>
    <textarea name="text" placeholder="Основной текст">{{ old('text') }}</textarea><br><br>
